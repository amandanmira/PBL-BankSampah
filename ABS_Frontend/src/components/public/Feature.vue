...
<template>
  <section class="py-16 md:py-24 bg-[#FAFFF9]">
    <!-- Added tight container with horizontal padding to guarantee cards never touch screen edges -->
    <div class="max-w-5xl lg:max-w-6xl mx-auto px-6 md:px-12 lg:px-16">
      
      <h2 class="text-center text-2xl md:text-3xl lg:text-[34px] font-extrabold text-[#555555] mb-12 md:mb-20 tracking-tight">
        Kemudahan Kelola Sampah di Ujung Jari.
      </h2>
      ...
      <div class="flex flex-col gap-10 md:gap-14 lg:gap-16">
        ...
        <div class="bg-[#925733] w-full md:w-[95%] mr-auto rounded-none rounded-r-[40px] md:rounded-r-[150px] lg:rounded-r-[200px] flex flex-col md:flex-row items-center gap-8 py-10 px-8 md:py-14 md:pl-12 lg:pl-16 md:pr-24 shadow-md">
          <div class="flex-1 text-center md:text-left">
            ...
            <p class="text-white/90 text-[15px] md:text-base leading-relaxed">
              Setiap sampah yang disetorkan akan ditimbang secara presisi dan dikonversi menjadi nilai Rupiah. Nasabah dapat menyimpan hasil konversi tersebut sebagai deposit di dalam aplikasi dan melakukan penarikan saldo secara fleksibel.
            </p>
          </div>
          <div class="flex-1 flex justify-center w-full">
            <img src="/hero.svg" alt="Ilustrasi Fitur 1" class="w-full max-w-[200px] md:max-w-[260px] lg:max-w-[300px] object-contain drop-shadow-xl hover:scale-105 transition-transform duration-500" />
          </div>
        </div>
        ...
        <div class="bg-[#777777] w-full md:w-[95%] mr-auto rounded-none rounded-r-[40px] md:rounded-r-[150px] lg:rounded-r-[200px] flex flex-col md:flex-row items-center gap-8 py-10 px-8 md:py-14 md:pl-12 lg:pl-16 md:pr-24 shadow-md">
          ...
          <div class="flex-1 flex justify-center w-full">
            <img src="/hero.svg" alt="Ilustrasi Fitur 3" class="w-full max-w-[200px] md:max-w-[260px] lg:max-w-[300px] object-contain drop-shadow-xl hover:scale-105 transition-transform duration-500" />
          </div>
        </div>
