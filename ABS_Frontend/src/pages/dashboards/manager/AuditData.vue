...
import { getListGudang, getListSampah, getAuditData, getAuditSummary, getAuditPenarikanData, getAuditPenarikanSummary, exportLaporanExcel, exportLaporanPdf } from '@/lib/api/manager/auditApi';
    ...
    <div class="space-y-6 animate-in fade-in duration-700 pb-10 font-['Inter']">
      ...
      <div>
        <p class="text-sm font-medium text-stone-500">
          {{ activeTab === 'Riwayat Sampah' ? 'Riwayat sampah dan transaksi untuk audit' : 'Riwayat penarikan saldo nasabah untuk audit' }}
        </p>
      </div>
