<template>
  <div class="container">
    ...
    <div v-if="gudang">
      ...
      <button @click="router.push(`/dashboard-admin/kelola-gudang/${id}/sampah`)">Manage Sampah</button>
      <button @click="router.push(`/dashboard-admin/kelola-gudang/${id}/tukang`)">Manage Tukang</button>
